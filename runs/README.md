...
**`notebooks/CHARTER_EPISTEMIC_NEWS_STREAM_SMOKE.ipynb`** runs next: small streaming slice of `fancyzhx/ag_news` + y-shuffle null + run card (epistemic lab / dataloader parity only).
