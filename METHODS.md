# Methodology — Lottery apriori emergence (epistemic lab)
...
## Lottery-specific epistemic limit

Observational draw CSVs support **null calibration**, **multiplicity-aware panels**, and **epistemic decomposition** of which tests fired on which axes. They **do not** identify Pearl-style structural causality of the physical draw mechanism, and they **do not** by themselves establish exploitable next-draw predictive edge. See also `lottoooo/apriori lotot research for research foundation.txt` (local path on steward machine).
