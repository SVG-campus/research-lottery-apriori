...
| Axis | % | Note |
|------|---:|------|
| Charter + prereg | 100 | Completed `docs/PREREG.md` for Lottery Draws Epistemic Null Baseline (ECT-2026-003) + `METHODS.md` |
...
## Lottery Attractor Complexity Collapse Validation (Kaggle Baseline)

| Evaluation Metric | Case A (Raw N=25) | Case B (Manifold d=3) | Metric Uplift (F1 delta) |
| :--- | :--- | :--- | :--- |
| **Out-Of-Fold F1 Score** | 0.7794 | 0.7857 | +0.0063 |
| **Search Space Complexity** | $O(2^{25})$ | $O(25^3)$ | Complexity Collapse |
